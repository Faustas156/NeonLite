...
namespace NeonWhiteQoL
{
    public class CommunityMedals
    {
        ...
        private static readonly Dictionary<string, (long, long)> CommunityMedalTimes = new()
        {
            ...
            ["TUT_FROG"] = (94749999L, 9139999L), // Cascade, 9.474 , 9.139
            ...
            ["GRID_PAGODA"] = (15789999L, 15249999L), // Take Flight, 15.789 , 15.249
            ...
            ["GRID_FLOCK"] = (12464666L, 11999999L), // Steps, 12.464, 11.999
            ...
            ["GRID_TRIPMAZE"] = (32816847L, 28999999L), // Triptrack, 32.816, 28.999
            ...
            ["GRID_MIMICPOP"] = (20076717L, 19378999L), // Trigger, 20.076, 19.378 // check deez times, deez what ? deez times
            ...
            ["GRID_ROCKETUZI"] = (39872898L, 37599999L), // Chute, 39.872, 37.599
            ...
            ["GRID_BOLT"] = (29229606L, 25599999L), // Bolt, 29.229, 25.599
            ["GRID_PON"] = (26999747L, 25799999L), // Godstreak, 26.999, 25.799
            ["GRID_CHARGE"] = (31121917L, 29759999L), // Plunge, 31.121, 29.759
            ["GRID_MIMICFINALE"] = (18188015L, 16624999L), // Mayhem, 18.188, 16.624
            ["GRID_BARRAGE"] = (31844284L, 28298999L), // Barrage, 31.844, 28.298
            ["GRID_1GUN"] = (36722186L, 31999999L), // Estate, 36.722, 31.999
            ...
            ["GRID_EXTERMINATOR"] = (8359876L, 7324951L), // Spree, 8.359 , 7.324
            ["GRID_FEVER"] = (5999972L, 5299999L), // Breakthrough, 5.999, 5.299
            ["GRID_SKIPSLIDE"] = (9899996L, 9029999L), // Glide 9.899, 9.029
            ["GRID_CLOSER"] = (12333912L, 10888999L), // Closer, 12.333, 10.888
            ["GRID_HIKE"] = (8059915L, 7199999L), // Hike, 8.059, 7.199
            ...
            ["SIDEQUEST_OBSTACLE_PISTOL"] = (14899888L, 14419999L), // Elevate Obstacle Course 1 (Elevate Traversal I), 14.899, 14.419 (formula used for these times may be slightly altered since i got more friends on neon white now xd)
            ...
            ["SIDEQUEST_OBSTACLE_RIFLE_2"] = (12874596L, 12569999L), // Godspeed Obstacle Course 1 (Godspeed Traversal), 12.874, 12.569 // change
            ...
            ["SIDEQUEST_ATTITUDE_ADJUSTMENT"] = (41512642L, 40167898L), // Attitude Adjustment, 41.512, 40.167
